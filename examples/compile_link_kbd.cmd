...
set link_opts4=-subsystem:native,5.0 -merge:.rdata=.text -PDBPATH:NONE -STACK:0x40000,0x1000 /opt:nowin98 -osversion:4.0 -version:4.0 /release -def:%process_kbd%.def %process_kbd%.res %process_kbd%.obj
...
del %process_kbd%.obj %process_kbd%.exp %process_kbd%.lib %process_kbd%.res
